...
public class GameManager : MonoBehaviour
{
    ...
    [SerializeField] private Vector2 starttouch = Vector2.zero;
    [SerializeField] private Vector2 endtouch = Vector2.zero;
    [SerializeField] private Vector2 deltatouch = Vector2.zero;
    ...
    void Update()
    {
        ...
        if(Input.touches.Length > 0)
        {
            ...
            else if(Input.touches[0].phase == TouchPhase.Ended)
            {
                ...
                deltatouch = starttouch - endtouch;

                if(deltatouch.x < -50) Shift(Vector2.right);
                else if(deltatouch.x > 50) Shift(Vector2.left);
                else if(deltatouch.y < -50) Shift(Vector2.up);
                else if(deltatouch.y > 50) Shift(Vector2.down);
